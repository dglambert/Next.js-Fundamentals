...
async function fetchSessions(){
  const speakerJsonUrl = "https://raw.githubusercontent.com/adhithiravi/Consuming-GraphqL-Apollo/master/api/data/sessions.json";
  const response = await fetch(speakerJsonUrl, {cache: "no-store" });
